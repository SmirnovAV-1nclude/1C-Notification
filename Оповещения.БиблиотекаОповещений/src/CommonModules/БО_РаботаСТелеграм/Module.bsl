...
Функция ПараметрыВзаимодействия(Токен = Неопределено, ИдентификаторПолучатель = Неопределено) 
...
// 	Соответствие
//  
Функция sendMessage(ПараметрыВзаимодействия, ТекстСообщения, Сессия = Неопределено) 
...
// 	Соответствие
//  
Функция sendPhoto(ПараметрыВзаимодействия, Файл, ТекстовоеОписание = "", Сессия = Неопределено) 
...
// 	Соответствие
//  
Функция sendAudio(ПараметрыВзаимодействия, Файл, ТекстовоеОписание = "", Сессия = Неопределено) 
...
// 	Соответствие 
//  
Функция sendDocument(ПараметрыВзаимодействия, Файл, ТекстовоеОписание = "", Сессия = Неопределено) 
...
// 	Соответствие
//  
Функция sendVideo(ПараметрыВзаимодействия, Файл, ТекстовоеОписание = "", Сессия = Неопределено) 
...
// 	Соответствие
//  
Функция sendMediaGroup(ПараметрыВзаимодействия, Файлы, ТекстовоеОписание = "", Сессия = Неопределено) 
